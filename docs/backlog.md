...
| 7   | Prevent duplicate voting        | Quality | Medium   | #3 writes voted_poll_ids; remaining: read it → skip form and redirect to results |
...
|   3 | Submit ballot                   | Value   | High     | `POST /polls/:id/ballots` + drag-and-drop vote page; writes `voted_poll_ids`    |
